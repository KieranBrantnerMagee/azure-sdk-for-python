...
from ._base_handler import _parse_conn_str, BaseHandler
from ._credentials import ServiceBusSharedKeyCredential, ServiceBusSharedTokenCredential, ServiceBusValidCredentialTypes
...
class ServiceBusClient(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # type: (str, ServiceBusValidCredentialTypes, Any) -> None
