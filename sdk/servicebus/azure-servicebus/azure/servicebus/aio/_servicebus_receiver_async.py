...
import functools
import logging
from typing import Any, List, Optional, AsyncIterator, Union
...
class ServiceBusReceiver(collections.abc.AsyncIterator, BaseHandler, ReceiverMixin):
    ...
    :param str fully_qualified_namespace: The fully qualified host name for the Service Bus namespace.
     The namespace format is: `<yournamespace>.servicebus.windows.net`.
    :param ServiceBusValidAsyncCredentialTypes credential: The credential object used for authentication
