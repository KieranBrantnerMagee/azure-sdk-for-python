...
from ._credentials_async import (
    ServiceBusSharedKeyCredential, ServiceBusSharedTokenCredential, ServiceBusValidAsyncCredentialTypes)
...
class ServiceBusClient(object):
    ...
    :param str fully_qualified_namespace: The fully qualified host name for the Service Bus namespace.
     The namespace format is: `<yournamespace>.servicebus.windows.net`.
    :param ServiceBusValidAsyncCredentialTypes credential: The credential object used for authentication which
