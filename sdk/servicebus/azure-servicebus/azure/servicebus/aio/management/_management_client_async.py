...
from ...aio._credentials_async import ServiceBusSharedKeyCredential, ServiceBusSharedTokenCredential
...
from .._credentials_async import ServiceBusValidAsyncCredentialTypes
...
class ServiceBusAdministrationClient:  #pylint:disable=too-many-public-methods
    ...
    :param credential: The credential object used for authentication
     which implements a particular interface for getting tokens. It accepts
    ...
    :paramtype credential: Union[~azure.core.credentials_async.AsyncTokenCredential,
     ~azure.servicebus.aio.ServiceBusSharedKeyCredential, ~azure.servicebus.aio.ServiceBusSharedTokenCredential]
    """
    ...
    def from_connection_string(cls, conn_str: str, **kwargs: Any) -> "ServiceBusAdministrationClient":
        ...
        if token and token_expiry:
            credential = ServiceBusSharedTokenCredential(token, token_expiry)
